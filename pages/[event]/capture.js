...
export default function Capture() {
  ...
  function takePhoto() {
      ...
      if (facingMode === "user") {
        ...
        stopCamera();
        sessionStorage.setItem("rawPhoto", dataUrl);
  ...
  function handleUpload(e) {
        ...
        reader.onload = () => {
                sessionStorage.setItem("rawPhoto", reader.result);
                router.push(`/${event}/result`);
        };
  ...
  return (
      ...
      <div className="card">
          <h1>Ambil Foto</h1>
        <p className="subtitle">Posisikan wajah kamu, lalu tekan tombol foto</p>
